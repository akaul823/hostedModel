...
Automatically generated by Colaboratory. I used Google Colab to architect my Torch model for hardware
compatibility purposes. I have included it in this file in order to showcase how I built the flower 
classifier.
